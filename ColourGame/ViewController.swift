...
class ViewController: UIViewController {
    ...
    checkEquivalency()
        ...
        clicks += 1
        print(clicks)
        if redAction + greenAction + blueAction == 0 {
            if clicks == 1 {
            message = "Perfect! Well done! " + "You only checked once!"
            } else {
            message = "Perfect! Well done! " + "You checked \(clicks) times"
            }
            
        } else {
        
            message = reds[redAction]
            + greens[greenAction]
            + blues[blueAction]
            + "You have checked \(clicks) times"
        }
